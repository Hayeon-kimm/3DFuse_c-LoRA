...
def inject_trainable_lora(
    ...
    for _module, name, _child_module in _find_modules(
        ...
        if verbose: # logging 출력
            print("LoRA Injection : injecting lora into ", name)
            print("LoRA Injection : weight shape", weight.shape)
        _tmp = LoraInjectedLinear( #lora linear layer
        ...
        _module._modules[name] = _tmp # lora적용된 module로 갈아끼우기

        require_grad_params.append(_module._modules[name].lora_up.parameters()) #lora_parameter 넣기(up->down 순서)
